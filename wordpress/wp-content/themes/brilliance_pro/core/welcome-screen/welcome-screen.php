...
class Brilliance_Welcome {
	...
	public function brilliance_welcome_style_and_scripts( $hook_suffix ) {
		...
		wp_enqueue_style( 'cpotheme-welcome-screen-css', get_template_directory_uri() . '/core/welcome-screen/css/welcome.css', array(), '2.3.3' );
		...
		<div class="wrap about-wrap epsilon-wrap">
			...
			<h2 class="nav-tab-wrapper wp-clearfix">
				...
				<a href="<?php echo esc_url( admin_url( 'themes.php?page=cpotheme-welcome&tab=registration' ) ); ?>"
				   class="nav-tab <?php echo $active_tab == 'registration' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Registration', 'brilliance' ); ?></a>
			...
			switch ( $active_tab ) {
				...
				case 'support':
					...
					break;
				case 'registration':
					do_action( 'brilliance-registration-section' );
					break;
				default:
					require_once get_template_directory() . '/core/welcome-screen/sections/getting-started.php';
					break;
