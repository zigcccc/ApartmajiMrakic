...
<div class="feature-section three-col" id="plugin-filter">
	<div class="col">
		<h3><?php _e('Install CPO Content Types', 'brilliance'); ?></h3>
		<p>
		...
		<?php 
			...
			switch ( $active['needs'] ) {
				case 'install':
					...
					$label = __( 'Install CPO Content Types', 'brilliance' );
					break;
				case 'activate':
					$class = 'activate-now button button-primary';
					$label = __( 'Activate CPO Content Types', 'brilliance' );
					break;
				case 'deactivate':
					$class = 'deactivate-now button';
					$label = __( 'Deactivate CPO Content Types', 'brilliance' );
					break;
			}
		...
		<h3><?php esc_html_e( 'Implement recommended actions', 'brilliance' ); ?></h3>
		...
		<?php if ( $count == 0 ) { ?>
			<p><span class="dashicons dashicons-yes"></span>
				<a target="_blank"
				   href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=recommended_actions' ); ?>"><?php esc_html_e( 'No recommended actions left to perform', 'brilliance' ); ?></a>
			</p>
		<?php } else { ?>
			<p><span class="dashicons dashicons-no-alt"></span> <a target="_blank"
			                                                       href="<?php echo admin_url( 'themes.php?page=cpotheme-welcome&tab=recommended_actions' ); ?>"><?php esc_html_e( 'Check recommended actions', 'brilliance' ); ?></a>
			</p> <?php
		}; ?>

	</div>
	<div class="col">
		<h3><?php _e('Add Custom Content Types', 'brilliance'); ?></h3>
		<p>
	...
	<div class="col">
		<h3><?php _e('Configure The Theme', 'brilliance'); ?></h3>
		<p>
