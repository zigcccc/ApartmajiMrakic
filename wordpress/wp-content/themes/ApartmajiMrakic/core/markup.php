...
function cpotheme_body_class($body_classes = ''){
	...
	if ( is_front_page() && !cpotheme_get_option( 'hide_slider' ) ) {
...
if ( !function_exists('cpotheme_add_page_title') ) {
	add_action( 'cpotheme_after_header_wrapper', 'cpotheme_add_page_title' );
	function cpotheme_add_page_title() {
		get_template_part('template-parts/element', 'page-header');
	}

}

if ( !function_exists('cpotheme_show_header_image') ) {
